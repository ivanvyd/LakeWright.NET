...
|---|---|---|
| **SQL warehouse** (classic/pro/serverless) | �o. Supported | �o. Supported |
| Serverless compute | �o. | �o. |
| Standard access mode | �o. DBR 12.2 LTS+ | �o. DBR 16.4+ |
| Dedicated access mode | �s�️ DBR 15.4 LTS+ read-only; writes DBR 16.3+; runs FGAC on serverless (billable) | �s�️ DBR 16.4+ with FGAC |
| DBR < 12.2 LTS | �O fails securely (returns no data) | �O |
| Iceberg REST catalog / Unity REST API | �O | �O |
| Delta Lake APIs | �O | �O |
...
- �s�️ **Contains a factual error**: claims schemas have "no hard limits on number". Contradicted by the limits page (10,000 per catalog). Don't cite this number.
