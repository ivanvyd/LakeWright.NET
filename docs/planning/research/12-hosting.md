...
�"o�"?�"? EntraManagedIdentityProvider   // Azure: DefaultAzureCredential �?' 2ff814a6-�?�/.default   [V]
�"o�"?�"? OidcFederationProvider         // K8s SA token / AWS IAM / CI OIDC �?' Databricks token exchange   [V]
...
```
GitHub repo
 �"o�"?�"? src/                       ASP.NET Core 10 app
 �"o�"?�"? Dockerfile                 multi-stage �?' aspnet:10.0-noble-chiseled, linux/amd64
 �"o�"?�"? docker-compose.yml         app + Postgres �?" the contributor on-ramp
 �"o�"?�"? infra/main.bicep           Azure reference deployment
